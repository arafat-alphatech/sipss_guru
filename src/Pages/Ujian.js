      ...
      <div>
        ...
        >
          <div className="card-body">
            ...
            <i className="far fa-address-book" style={{marginRight:'10px', color:'#1f3a93'}}></i>
              40 siswa
            </p>
            <p className="card-text">
            ...
            <p className="card-text" ><i className="fas fa-list-ol" style={{marginRight:'10px', color:'#1f3a93'}}></i>25 Soal</p>
          </div>
